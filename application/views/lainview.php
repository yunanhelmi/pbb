		...
		<table width="100%">
			<tr>
				<td width="50%">
					<p style="font-family:arial;text-align:center;">PENDAPATAN PAJAK LAIN-LAIN 2015</p>
					<div id="container" style="height: 400px"></div>
				</td>
				<td width="50%" align="center">
					<div class="CSSTableGenerator3" style="margin-top:-50px">
						<table border="1" width="70%" cellspacing="0" cellpadding="0">
							<tr>
								<td colspan="4">PENDAPATAN PAJAK LAIN-LAIN TAHUN 2015</td>
							</tr>
							<tr>
